...
/**
 * Created by chenqiao on 1/18/21.
...
class ScreenSizeUtil {
    ...
    public static DisplayMetrics getDisplayMetrics() {
        WindowManager wm = (WindowManager) ApplicationContextProvider.Companion.getApplication().getSystemService(Context.WINDOW_SERVICE);
